const avodraw_initialized = true;
...
let dot = (x, y, color, style, alpha) => Canvas.Dot(x, y, color, style, alpha);
let write = (x, y, text, size, color, style, alpha) => Canvas.Write(x, y, text, size, color, style, alpha);


const avoloop_initialized = true;
...
const avomatrix_initialized = true;
/**
 * @version 1.0.0
 * @author AvoLord
