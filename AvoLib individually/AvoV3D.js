const v3d_initialized = true;

if(!avomatrix_initialized) {
  throw new Error("showV3D(), connectV3D(), transformV3D(), MattoV3D(), V3DtoMat(), and the rotate-functions require AvoMatrix.js");
}
